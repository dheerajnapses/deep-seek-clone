    ...
    <div className="flex flex-col min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
      ...
      <Card className="w-full max-w-[430px]">
        <CardHeader className="space-y-1 text-center">
          {/* <CardTitle className="text-2xl font-semibold">deepseek</CardTitle> */}
          <CardDescription>
        ...
        <CardContent>
          ...
          <div className="mt-4 flex items-center justify-between">
            <Button variant="link" className="px-0 text-blue-500 text-sm" asChild>
          ...
          <Button variant="outline" className="mt-6 w-full" onClick={handleGoogleSignIn}>
